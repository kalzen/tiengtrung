...
import { JSX, useCallback, useEffect, useMemo, useState, lazy, Suspense } from "react"
...
const LexicalTypeaheadMenuPlugin = lazy(() => import("./default/lexical-typeahead-menu-plugin"))
